...
function installAddAptRepositor {
  echo ""
  echo "### JDK : Install  add-apt-repositor"
  echo "### ########################################################"
  apt-get install -q -y  --force-yes software-properties-common python-software-properties
}

function installJDK7 {
    echo ""
    echo "### JDK : Install Java 7"
    echo "### ########################################################"
    add-apt-repository ppa:webupd8team/java
    apt-get update
    echo "debconf shared/accepted-oracle-license-v1-1 select true" | debconf-set-selections
    echo "debconf shared/accepted-oracle-license-v1-1 seen true" | debconf-set-selections
    apt-get install -q -y  --force-yes oracle-java7-installer
}


function installJDK8Debian {
    echo ""
    echo "### JDK : Install Java 8 Debian"
    echo "### ########################################################"
